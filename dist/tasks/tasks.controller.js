...
let TasksController = class TasksController {
    ...
    getTasks(filterDto, user) {
        this.logger.verbose(`User "${user.username}" is retrieving all tasks. With filters: ${JSON.stringify(filterDto)}`);
    ...
    createTask(createTaskDto, user) {
        this.logger.log(`User "${user.username}" has just created a task with data: ${JSON.stringify(createTaskDto)}`);
